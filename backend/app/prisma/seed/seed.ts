...
const seedFriends = async (): Promise<void> => {
  await prisma.user.update({
    ...
    data: {
      friends: {
        create: [
          { friend_id: seededUsers[1].id, status: FriendStatus.ACCEPTED },
        ],
      },
    },
  });
  ...
  await prisma.user.update({
    ...
    data: {
      friends: {
        create: [
          { friend_id: seededUsers[3].id, status: FriendStatus.PENDING },
          { friend_id: seededUsers[4].id, status: FriendStatus.ACCEPTED },
        ],
      },
    },
  });
  ...
  await prisma.user.update({
    ...
    data: {
      friends: {
        create: [
          { friend_id: seededUsers[6].id, status: FriendStatus.ACCEPTED },
          { friend_id: seededUsers[7].id, status: FriendStatus.ACCEPTED },
          { friend_id: seededUsers[8].id, status: FriendStatus.PENDING },
        ],
      },
    },
  });
...
const seedBlocks = async (): Promise<void> => {
  ...
  await prisma.user.update({
    ...
    data: {
      blocked: {
        create: [
          { blocked_id: seededUsers[0].id },
          { blocked_id: seededUsers[2].id },
        ],
      },
    },
  });
...
const seedMessages = async (): Promise<void> => {
  await prisma.user.update({
    ...
    data: {
      senders: {
        create: [
          {
            message: `Hello, I am ${seededUsers[1].name}`,
            receiver_id: seededUsers[2].id,
          },
        ],
      },
    },
  ...
  await prisma.user.update({
    ...
    data: {
      senders: {
        create: [
          {
            message: `Hello, I am ${seededUsers[2].name}`,
            receiver_id: seededUsers[1].id,
          },
        ],
      },
    },
  ...
  await prisma.user.update({
    ...
    data: {
      senders: {
        create: [{ message: `How are you ?`, receiver_id: seededUsers[1].id }],
      },
    },
  });
  await prisma.user.update({
...
const seedChannels = async (): Promise<void> => {
  let channels: Prisma.ChannelsCreateInput[] = Array.from(
    { length: 2 },
    (v, i) => ({
      name: faker.name.firstName(),
      type: 'PUBLIC',
      users: {
        create: { type: ChannelUserType.OWNER, user_id: seededUsers[i].id },
      },
    }),
  );
  channels.push({
    ...
    type: 'PRIVATE',
    users: {
      create: { type: ChannelUserType.OWNER, user_id: seededUsers[2].id },
    },
  });
  channels.push({
    name: faker.name.firstName(),
    ...
    users: {
      create: { type: ChannelUserType.OWNER, user_id: seededUsers[3].id },
    },
  });
...
const seedChannelMessages = async (): Promise<void> => {
  ...
  await prisma.channels.update({
    ...
    data: {
      channel_messeges: {
        create: [{ message: 'Hello, i am owner', user_id: seededUsers[2].id }],
      },
    },
  });
};
