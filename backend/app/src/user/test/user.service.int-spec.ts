...
describe('UserService', () => {
  ...
  describe('getRequestUserFriends', () => {
    it('should return userFriends with PENDING status, (waiting to be accepted)', async () => {
      const userFriends = await userService.getRequestedUserFriends(
        users[0].id,
      );
  ...
  describe('updateUserFriends', () => {
    ...
    it('should return updated UserFriends', async () => {
      userFriend = await userService.updateUserFriends(
        users[1].id,
        { status: 'ACCEPTED' },
        users[2].id,
      );
  ...
  describe('createUserMessages', () => {
    ...
    it('should create some userMessages', async () => {
      msg = await userService.createUserMessages(
        users[1].id,
        { message: 'Sup bro' },
        users[2].id,
      );
    ...
    it('should throw HttpException due to kena blocked', async () => {
      const errorfn = async () => {
        await userService.createUserMessages(
          users[0].id,
          { message: 'Why am I blocked ?' },
          users[2].id,
        );
      };
  ...
  describe('getAcceptedUserFriends', () => {
    ...
    it('should return UserFriends with ACCEPTED status', async () => {
      userFriends = await userService.getAcceptedUserFriends(
        users[1].id,
        users[0].id,
      );
  ...
  describe('deleteUserFriend', () => {
    it('should delete a userFriend', async () => {
      const deleted = await userService.deleteUserFriend(
        users[2].id,
        users[1].id,
      );
  ...
  describe('deleteUserBlock', () => {
    ...
    it('should delete a userBlock', async () => {
      const userBlock = await userService.deleteUserBlock(
        users[2].id,
        users[0].id,
      );
