    ...
    >
      ...
      <ProCard>
        <Row gutter={10}>
          ...
          <Col span={20}>
            <UserInformation
              {...{ user: user!, messageApi, setUser }}
              isLoading={getUserIsloading}
              isMe={props.isMe}
            />
          </Col>
        </Row>
        <Row className="py-5" gutter={10}>
          <Col span={12}>
            <UserFriendList
              {...{
                chats,
              ...
              isLoading={
                getChatsIsLoading ||
                getPendingFriendsIsLoading ||
                getAcceptedFriendsIsLoading ||
                getBlockedIsLoading ||
                getRequestedFriendsIsLoading
              }
              isMe={props.isMe}
            />
          </Col>
        ...
        <Row gutter={10}>
          ...
          <Col span={12}>
            <UserMatchHistory
              {...{ matches }}
              isLoading={getMatchHistoriesIsLoading}
            />
          </Col>
        </Row>
      </ProCard>
      <UploadModal
        {...{ setUploadModalIsOpen, uploadImageMutation, uploadModalIsOpen }}
      />
    </PageContainer>
  );
}
  ...
  return (
    ...
    >
      <Form
        ...
        onFinish={(data) => {
          handleUpload();
          props.setUploadModalIsOpen(false);
        }}
      >
        <Form.Item
          name="image"
